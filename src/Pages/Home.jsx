        ...
        <div className="flex flex-col lg:flex-row items-top justify-between gap-12 relative ">
          ...
          <div className="flex-1 space-y-10">
            ...
            <div className="w-full md:w-200 absolute z-90 bg-white p-4 shadow-[0_8px_30px_rgb(0,0,0,0.08)] flex flex-col md:flex-row items-center gap-2 ">
              <div className="flex items-center gap-2 flex-1 px-4 py-2 w-full md:w-auto md:borderr bordergray-200">
                <FiSearch className="text-[#25324B] text-2xl" />
                <input
                  type="text"
                  placeholder="Job title or keyword"
                  className="bg-transparent py-2.25 outline-none w-full text-gray-700 placeholder-gray-400 borderb-[1px] border[#7C8493]"
                />
              </div>
              <div className="flex items-center gap-2 flex-1 px-4 py-2 w-full md:w-auto">
                ...
                <select
                  ...
                  className=" focus:outline-none bg-transparent py-2.25 w-full text-gray-700 placeholder-gray-400 borderb-[1px] border[#7C8493]"
                >
