    ...
    <div className="py-16 relative">
      ...
      <div className="flex flex-col lg:flex-row items-top justify-between gap-12 relative ">
        ...
        <div className="flex-1 space-y-10">
          ...
          {/* Search Box */}
          <div className="w-full md:w-200 absolute z-90 h-22.25 bg-white p-4 shadow-[0_8px_30px_rgb(0,0,0,0.08)] flex flex-col md:flex-row items-center gap-2 ">
          ...
          <p className="text-sm absolute bottom-28 text-gray-500">
            Popular :{" "}
        ...
        <div className="flex-1 hidden md:flex justify-center lg:justify-end relative">
          ...
          <img
            src={rectangleImage}
            alt="Rectangle Image"
            className="absolute -bottom-20 w-[90%] z-10"
          />
        </div>
      </div>
    </div>
